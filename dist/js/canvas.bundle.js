...
function Particle(x, y, radius, color) {
  ...
  this.update = function () {
    ...
    _this.radians = _this.radians + _this.velocity;
    _this.lastMouse.x = _this.lastMouse.x + (mouse.x - _this.lastMouse.x) * 0.05;
    _this.lastMouse.y = _this.lastMouse.y + (mouse.y - _this.lastMouse.y) * 0.05;
